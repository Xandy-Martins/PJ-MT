...
<div class="collapse" id="collapseExample3">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="team-member">
							<img class="mx-auto rounded-circle" src="img/anderson..png" alt="">
							<h4>Anderson dos Santos</h4>
							<p class="text-muted"> Abreu e Lima-PE</p>
							<p class="text-muted"></p>
					...
					<div class="col-sm-4">
						<div class="team-member">
							<img class="mx-auto rounded-circle" src="img/lucy.png" alt="">
					...
					<div class="col-sm-4">
						<div class="team-member">
							<img class="mx-auto rounded-circle" src="img/tuano.png" alt="">
							<h4>Tuano Danillo</h4>
							<p class="text-muted">Itapissuma-PE</p>
							<p class="text-muted"></p>
							<ul class="list-inline social-buttons"
								<li class="list-inline-item">
																		</a>
 ...
 <section id="about">
      ...
      <h1><h1>
		...
		<script src="bootstrap-4.0.0-dist/js/app.js"></script>
